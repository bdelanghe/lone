...
This checklist mirrors the MDN accessibility testing guidance and maps each item
to automated validators or manual testing guides.
...
- The MDN good-semantics example is captured in `examples/mdn-good-semantics/`
  and validated in `tests/validate/semantic_html_mdn_test.ts`.
